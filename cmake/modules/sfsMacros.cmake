...
Macro (sfs_Generate_Version_Info)
  #Add_Custom_Target(svnr3bheader ALL)
  Add_Custom_Target(svnsfsheader ALL)

  #Add_Custom_Command(TARGET svnr3bheader
  Add_Custom_Command(TARGET svnsfsheader
                     ...
                     -P ${CMAKE_SOURCE_DIR}/cmake/modules/sfsGenerateVersionInfo.cmake
                    )
#EndMacro (R3B_Generate_Version_Info)
EndMacro (sfs_Generate_Version_Info)
