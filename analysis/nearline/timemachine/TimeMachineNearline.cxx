...
{
    sfsLOG_IF(fatal, (fNumDetectorSystems == 0) || (fNumDetectorSystems < 0), "Detector systems not specified for TimeMachineNearline. Please add SetDetectorSystems before Init().");
