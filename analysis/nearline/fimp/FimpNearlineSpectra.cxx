...
FimpNearlineSpectra::~FimpNearlineSpectra()
{
    sfsLOG(info, "Destroyied FimpNearlineSpectra properly.");
}
...
InitStatus FimpNearlineSpectra::Init()
{
    ...
    sfsLOG_IF(fatal, !fimpRawArray, "Branch FimpData not found!");
    fimpCalArray = mgr->InitObjectAs<decltype(fimpCalArray)>("FimpCalData");
    sfsLOG_IF(fatal, !fimpCalArray, "Branch FimpCalData not found!");
