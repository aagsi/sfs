...
InitStatus FrsAidaBplastGermaniumCorrelations::Init()
{
    ...
    sfsLOG_IF(fatal, !fHitbPlast, "Branch bPlastCalData not found!");
    fHitGe = (TClonesArray*)mgr->GetObject("GermaniumData");
    sfsLOG_IF(fatal, !fHitGe, "Branch GermaniumData not found!");
    fHitFrs = (TClonesArray*)mgr->GetObject("FrsHitData");
    sfsLOG_IF(fatal, !fHitFrs, "Branch FrsHitData not found!");
