...
FatimaGermaniumCorrelations::~FatimaGermaniumCorrelations()
{
    sfsLOG(info, "Deleting FatimaGermaniumCorrelation.");
    if (fHitFatima)
        delete fHitFatima;
    if (fHitGermanium)
...
InitStatus FatimaGermaniumCorrelations::Init()
{
    ...
    sfsLOG_IF(fatal, !fHitGermanium, "Branch FrsHitData not found!");
...
void FatimaGermaniumCorrelations::FinishTask()
{
    ...
    gDirectory = tmp;
    sfsLOG(info, "Germanium-Fatima histograms written to file.");
}
