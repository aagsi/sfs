...
{   
    ...
    if (fHitGe && fHitGe->GetEntriesFast() > 0 && aida_hit_time != 0)
    {
        ...
        {   
            ...
            //     //sfsLOG(info,Form("ge_time = %li, aida_time = %li, diff = %li, energy = %f",ge_time,aida_hit_time, (int64_t)ge_time-(int64_t)aida_hit_time,energy1));
            // }
...
void AidaGermaniumCorrelations::FinishTask()
{
    ...
    if (fHitGe && implantHitArray)
    {
        ...
        sfsLOG(info, "DEGAS-AIDA histograms written to file.");
    }
}
