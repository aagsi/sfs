...
InitStatus BeamMonitorOnlineSpectra::Init()
{
    ...
    sfsLOG_IF(fatal, !s2HitsBM, "Branch BeamMonitorS2Data not found!");

    s4HitsBM = mgr->InitObjectAs<decltype(s4HitsBM)>("BeamMonitorS4Data");
    sfsLOG_IF(fatal, !s4HitsBM, "Branch BeamMonitorS4Data not found!");
...
{
    sfsLOG(info, "Not currently functional.");
}
