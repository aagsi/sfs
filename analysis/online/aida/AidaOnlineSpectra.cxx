...
{
    sfsLOG(info, "Destroyed AidaOnlineSpectra properly.");
...
{
    sfsLOG(info, "Resetting AIDA scalers.");
    for (auto& scaler : conf->ScalerMap())
    {
        aida_scaler_queue[scaler.first].clear();
        aida_scaler_cur_sec[scaler.first] = -1;
    ...
    sfsLOG(info, "AIDA scalers reset.");
}
