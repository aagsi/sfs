...
void LisaOnlineSpectra::Reset_Histo()
{
    ...
    sfsLOG(info,"::: Energy and Multiplicity Histos Reset on day " <<  ltm->tm_mday << "th," << " at " << ltm->tm_hour << ":" << ltm->tm_min << ":" << ltm->tm_sec );
    //Reset Energy histos
...
{   
    ...
    for (auto const & lisaCalItem : *lisaCalArray)
    {
        ...
        //sfsLOG(info, "sum_energy layer 1: "<< sum_energy_layer[1]);
        //sfsLOG(info, "sum_energy layer 2: "<< sum_energy_layer[2]);
...
*/
    ...
    for(int i = 0; i < layer_number; i++)
    {
        //sfsLOG(info,"multiplicity : "<< multiplicity[i] << " i : " << i );
    }
