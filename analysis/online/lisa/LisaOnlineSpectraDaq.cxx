...
InitStatus LisaOnlineSpectraDaq::Init()
{
    ...
    sfsLOG(info, " before hit pattern layer : " << layer_number );
...
void LisaOnlineSpectraDaq::Reset_Histo()
{
    ...
    sfsLOG(info,"::: Histos Reset on day " <<  ltm->tm_mday << "th," << " at " << ltm->tm_hour << ":" << ltm->tm_min << ":" << ltm->tm_sec );
...
{   
    ...
    for (auto const & lisaCalItem : *lisaCalArray)
    {
        ...
        //sfsLOG(info, ":::::::beginning loop inside exec :::::::: ");
        ...
        //sfsLOG(info, ":::::::beginning loop after return :::::::: ");
        ...
        //sfsLOG(info, " exec layer : " << layer << "layer number : "<< layer_number );
        ...
        //sfsLOG(info, "pileup : "<< pileup<< "overflow : " << overflow );
        ...
        //sfsLOG(info, "num layer: " << num_layers << " x max: " << xmax << " ymax: " << ymax);
    ...
    //sfsLOG(info, " layer : "<<layer << " multiplicity layer : "<<multiplicity[layer]);
    if ( wr_time == 0 ) return;
    ...
    //sfsLOG(info, " outside exec layer number: " << layer_number );
    ...
    for(int i = 0; i < layer_number; i++)
    {
        sfsLOG(info,"layer_number : " << layer_number << "multiplicity : "<< multiplicity[i] << " i : " << i );
    }

    sfsLOG(info, "counter again : "<< counter);
