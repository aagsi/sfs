...
InitStatus TimeMachineOnline::Init()
{
    ...
    sfsLOG_IF(fatal, (fNumDetectorSystems == 0) || (fNumDetectorSystems < 0), "Detector systems not specified for TimeMachineOnline. Please add SetDetectorSystems before Init().");
    ...
    for (int det = 0; det<fNumDetectorSystems; det++)
    {
        ...
        sfsLOG_IF(fatal, !fTimeMachine[det], "Branch TimeMachineData not found!");
    }
