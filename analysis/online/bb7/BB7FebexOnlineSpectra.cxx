...
{
    sfsLOG(info, "Destroyed BB7FebexOnlineSpectra properly.");
}
...
InitStatus BB7FebexOnlineSpectra::Init()
{
    ...
    sfsLOG_IF(fatal, !implantHitArray, "Branch BB7FebexImplants not found!");
    decayHitArray = mgr->InitObjectAs<decltype(decayHitArray)>("BB7FebexDecays");
    sfsLOG_IF(fatal, !decayHitArray, "Branch BB7FebexDecays not found!");
