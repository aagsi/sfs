...
InitStatus FatimaOnlineSpectra::Init()
{
    ...
    sfsLOG_IF(fatal, !fHitFatimaTwinpeaks, "Branch FatimaTwinpeaksCalData not found!");
...
{
    if(fNEvents == 0){
        sfsLOG(warning, "No events processed, histograms will not be saved!");
        return;
    }
    if (fHitFatimaTwinpeaks)
    {
