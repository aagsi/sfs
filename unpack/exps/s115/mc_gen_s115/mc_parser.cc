...
#line 32 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
...
#line 172 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
                                { append_list(&all_mc_defs,(yyvsp[0].nodes)); }
#line 1261 "mc_gen_s115/y.tab.c"
    break;

  case 4: /* stmt_list: stmt  */
#line 177 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
                                { (yyval.nodes) = create_list((yyvsp[0].node)); }
#line 1267 "mc_gen_s115/y.tab.c"
    break;

  case 5: /* stmt_list: stmt_list stmt  */
#line 178 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
                                { (yyval.nodes) = append_list((yyvsp[-1].nodes),(yyvsp[0].node)); }
#line 1273 "mc_gen_s115/y.tab.c"
    break;

  case 6: /* stmt: ';'  */
#line 183 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
                                                   { (yyval.node) = NULL; }
#line 1279 "mc_gen_s115/y.tab.c"
    break;

  case 7: /* stmt: signal_mapping  */
#line 184 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
                                                   { (yyval.node) = (yyvsp[0].map); }
#line 1285 "mc_gen_s115/y.tab.c"
    break;

  case 8: /* stmt: calib_param  */
#line 185 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
                                                   { (yyval.node) = (yyvsp[0].calib); }
#line 1291 "mc_gen_s115/y.tab.c"
    break;

  case 9: /* stmt: user_calib_param  */
#line 186 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
                                                   { (yyval.node) = (yyvsp[0].user_calib); }
#line 1297 "mc_gen_s115/y.tab.c"
    break;

  case 10: /* signal_mapping: SIGNAL_MAPPING '(' data_type ',' data_name ',' var_or_name ',' toggle_null var_or_name ')' ';'  */
#line 195 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
          {
...
#line 1333 "mc_gen_s115/y.tab.c"
    break;

  case 12: /* calib_param: CALIB_PARAM '(' IDENTIFIER ',' calib_type ',' value_vector_np ')' ';'  */
#line 232 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
          {
	    signal_id id;
...
#line 1348 "mc_gen_s115/y.tab.c"
    break;

  case 13: /* calib_param: CALIB_PARAM '(' toggle IDENTIFIER ',' calib_type ',' value_vector_np ')' ';'  */
#line 243 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
          {
	    signal_id id;
	    dissect_name(CURR_FILE_LINE,(yyvsp[-6].strValue),id);
	    const signal_id_info *src_info  =
...
#line 1363 "mc_gen_s115/y.tab.c"
    break;

  case 14: /* calib_param: CALIB_PARAM_C '(' var_or_name ',' calib_type ',' value_vector_np ')' ';'  */
#line 254 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
          {
	    const signal_id_info *src_info  =
...
#line 1377 "mc_gen_s115/y.tab.c"
    break;

  case 15: /* calib_param: CALIB_PARAM_C '(' toggle var_or_name ',' calib_type ',' value_vector_np ')' ';'  */
#line 264 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
          {
	    const signal_id_info *src_info  =
	      get_signal_id_info((yyvsp[-6].var),SID_MAP_RAW | SID_MAP_MIRROR_MAP);
	    const signal_id_info *dest_info =
...
#line 1391 "mc_gen_s115/y.tab.c"
    break;

  case 16: /* calib_param: var_or_name '=' calib_type '(' value_vector_np ')' ';'  */
#line 274 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
          {
	    const signal_id_info *src_info  =
	      get_signal_id_info((yyvsp[-6].var),SID_MAP_RAW | SID_MAP_MIRROR_MAP);
	    const signal_id_info *dest_info =
...
#line 1405 "mc_gen_s115/y.tab.c"
    break;

  case 17: /* calib_param: toggle var_or_name '=' calib_type '(' value_vector_np ')' ';'  */
#line 284 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
          {
	    const signal_id_info *src_info  =
	      get_signal_id_info((yyvsp[-6].var),SID_MAP_RAW | SID_MAP_MIRROR_MAP);
	    const signal_id_info *dest_info =
...
#line 1419 "mc_gen_s115/y.tab.c"
    break;

  case 18: /* user_calib_param: CALIB_PARAM '(' IDENTIFIER ',' value_vector_np ')' ';'  */
#line 297 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
          {
	    signal_id id;
...
#line 1431 "mc_gen_s115/y.tab.c"
    break;

  case 19: /* user_calib_param: CALIB_PARAM_C '(' var_or_name ',' value_vector_np ')' ';'  */
#line 305 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
          {
	    const signal_id_info *dest_info =
...
#line 1442 "mc_gen_s115/y.tab.c"
    break;

  case 20: /* user_calib_param: var_or_name '=' value_vector_np_single ';'  */
#line 312 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
          {
	    const signal_id_info *dest_info =
...
#line 1453 "mc_gen_s115/y.tab.c"
    break;

  case 21: /* user_calib_param: var_or_name '=' '{' value_vector_np '}' ';'  */
#line 319 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
          {
	    const signal_id_info *dest_info =
...
#line 1464 "mc_gen_s115/y.tab.c"
    break;

  case 22: /* calib_type: IDENTIFIER  */
#line 336 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
                     { (yyval.iValue) = calib_param_type((yyvsp[0].strValue));
	    if (!(yyval.iValue)) { yyerror("Unknown calibration type."); YYERROR; } }
#line 1471 "mc_gen_s115/y.tab.c"
    break;

  case 23: /* data_type: IDENTIFIER  */
#line 343 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
                     { (yyval.iValue) = 0; /* $$ = data_type($1); if (!$$) { yyerror("Unknown data type."); YYERROR; } */ }
#line 1477 "mc_gen_s115/y.tab.c"
    break;

  case 24: /* toggle_null: %empty  */
#line 347 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
                      { (yyval.iValue) = 0; }
#line 1483 "mc_gen_s115/y.tab.c"
    break;

  case 26: /* toggle: TOGGLE INTEGER ':'  */
#line 352 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
                             {
...
#line 1495 "mc_gen_s115/y.tab.c"
    break;

  case 27: /* var_or_name: var_ident_rec  */
#line 362 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
                        { (yyval.var) = new signal_id(); (yyval.var)->take_over((yyvsp[0].var_vect)); /* Note: this deletes $1! */ }
#line 1501 "mc_gen_s115/y.tab.c"
    break;

  case 28: /* data_name: IDENTIFIER  */
#line 366 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
                     { (yyval.var) = NULL; /* $$ = new signal_id(); dissect_name(0,$1,*$$); */ }
#line 1507 "mc_gen_s115/y.tab.c"
    break;

  case 29: /* var_ident_rec: var_ident  */
#line 370 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
                                      { (yyval.var_vect) = (yyvsp[0].var_vect); }
#line 1513 "mc_gen_s115/y.tab.c"
    break;

  case 30: /* var_ident_rec: var_ident_rec '.' var_ident  */
#line 371 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
...
#line 1519 "mc_gen_s115/y.tab.c"
    break;

  case 31: /* var_ident: IDENTIFIER array_spec_list_null  */
#line 376 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
          {
...
#line 1533 "mc_gen_s115/y.tab.c"
    break;

  case 32: /* array_spec_list_null: %empty  */
#line 388 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
                                       { (yyval.var_vect) = NULL; }
#line 1539 "mc_gen_s115/y.tab.c"
    break;

  case 33: /* array_spec_list_null: array_spec_list  */
#line 389 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
                                       { (yyval.var_vect) = (yyvsp[0].var_vect); }
#line 1545 "mc_gen_s115/y.tab.c"
    break;

  case 34: /* array_spec_list: array_spec  */
#line 393 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
                                       { (yyval.var_vect) = new sig_part_ptr_vector; (yyval.var_vect)->push_back((yyvsp[0].var_part)); }
#line 1551 "mc_gen_s115/y.tab.c"
    break;

  case 35: /* array_spec_list: array_spec_list array_spec  */
#line 394 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
                                       { (yyvsp[-1].var_vect)->push_back((yyvsp[0].var_part)); (yyval.var_vect) = (yyvsp[-1].var_vect); }
#line 1557 "mc_gen_s115/y.tab.c"
    break;

  case 36: /* array_spec: '[' INTEGER ']'  */
#line 398 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
                                       { (yyval.var_part) = new sig_part((yyvsp[-1].iValue)); }
#line 1563 "mc_gen_s115/y.tab.c"
    break;

  case 37: /* value_vector_np: value_vector_np_single  */
#line 410 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
                                            { (yyval.v_double_unit) = (yyvsp[0].v_double_unit); }
#line 1569 "mc_gen_s115/y.tab.c"
    break;

  case 38: /* value_vector_np: value_vector_np ',' value_unit  */
#line 411 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
                                            { (yyval.v_double_unit) = (yyvsp[-2].v_double_unit); (yyval.v_double_unit)->push_back((yyvsp[0].du)); }
#line 1575 "mc_gen_s115/y.tab.c"
    break;

  case 39: /* value_vector_np_single: value_unit  */
#line 415 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
                                            { (yyval.v_double_unit) = new vect_double_unit; (yyval.v_double_unit)->push_back((yyvsp[0].du)); }
#line 1581 "mc_gen_s115/y.tab.c"
    break;

  case 40: /* value_unit: value  */
#line 419 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
                                  { (yyval.du)._value = (yyvsp[0].fValue); (yyval.du)._unit = NULL; }
#line 1587 "mc_gen_s115/y.tab.c"
    break;

  case 41: /* value_unit: value unit  */
#line 420 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
                                  { (yyval.du)._value = (yyvsp[-1].fValue); (yyval.du)._unit = insert_units_exp(CURR_FILE_LINE,(yyvsp[0].strValue)); }
#line 1593 "mc_gen_s115/y.tab.c"
    break;

  case 42: /* value: DOUBLE  */
#line 425 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
                                  { (yyval.fValue) = (yyvsp[0].fValue); }
#line 1599 "mc_gen_s115/y.tab.c"
    break;

  case 43: /* value: INTEGER  */
#line 426 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
                                  { (yyval.fValue) = (yyvsp[0].iValue); }
#line 1605 "mc_gen_s115/y.tab.c"
    break;

  case 44: /* value: '-' value  */
#line 427 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
                                  { (yyval.fValue) = -(yyvsp[0].fValue); }
#line 1611 "mc_gen_s115/y.tab.c"
    break;

  case 45: /* value: '+' value  */
#line 428 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
                                  { (yyval.fValue) = (yyvsp[0].fValue); }
#line 1617 "mc_gen_s115/y.tab.c"
    break;

  case 46: /* value: value '+' value  */
#line 429 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
                                  { (yyval.fValue) = (yyvsp[-2].fValue) + (yyvsp[0].fValue); }
#line 1623 "mc_gen_s115/y.tab.c"
    break;

  case 47: /* value: value '-' value  */
#line 430 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
                                  { (yyval.fValue) = (yyvsp[-2].fValue) - (yyvsp[0].fValue); }
#line 1629 "mc_gen_s115/y.tab.c"
    break;

  case 48: /* value: value '*' value  */
#line 431 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
                                  { (yyval.fValue) = (yyvsp[-2].fValue) * (yyvsp[0].fValue); }
#line 1635 "mc_gen_s115/y.tab.c"
    break;

  case 49: /* value: value '/' value  */
#line 433 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
          {
	    if ((yyvsp[0].fValue) == 0.0)
	      yyerror("Warning: Division by zero.");
	    (yyval.fValue) = (yyvsp[-2].fValue) / (yyvsp[0].fValue);
	  }
#line 1645 "mc_gen_s115/y.tab.c"
    break;

  case 50: /* value: '(' value ')'  */
#line 438 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
                                  { (yyval.fValue) = (yyvsp[-1].fValue); }
#line 1651 "mc_gen_s115/y.tab.c"
    break;

  case 51: /* unit: STRING  */
#line 443 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
                        { (yyval.strValue) = (yyvsp[0].strValue); }
#line 1657 "mc_gen_s115/y.tab.c"
    break;

  case 52: /* unit: unit_part  */
#line 444 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
                        { (yyval.strValue) = (yyvsp[0].strValue); }
#line 1663 "mc_gen_s115/y.tab.c"
    break;

  case 53: /* unit: '/' unit_part  */
#line 445 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
                        { (yyval.strValue) = find_concat_str_strings("/",(yyvsp[0].strValue),""); }
#line 1669 "mc_gen_s115/y.tab.c"
    break;

  case 54: /* unit_part: unit_part_many  */
#line 449 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
                                       { (yyval.strValue) = (yyvsp[0].strValue); }
#line 1675 "mc_gen_s115/y.tab.c"
    break;

  case 55: /* unit_part: unit_part_many '*' unit_part  */
#line 450 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
                                       { (yyval.strValue) = find_concat_str_strings((yyvsp[-2].strValue),"*",(yyvsp[0].strValue)); }
#line 1681 "mc_gen_s115/y.tab.c"
    break;

  case 56: /* unit_part: unit_part_many '/' unit_part  */
#line 451 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
                                       { (yyval.strValue) = find_concat_str_strings((yyvsp[-2].strValue),"/",(yyvsp[0].strValue)); }
#line 1687 "mc_gen_s115/y.tab.c"
    break;

  case 57: /* unit_part_many: unit_part_block  */
#line 455 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
                                         { (yyval.strValue) = (yyvsp[0].strValue); }
#line 1693 "mc_gen_s115/y.tab.c"
    break;

  case 58: /* unit_part_many: unit_part_many unit_part_block  */
#line 456 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
                                         { (yyval.strValue) = find_concat_str_strings((yyvsp[-1].strValue)," ",(yyvsp[0].strValue)); }
#line 1699 "mc_gen_s115/y.tab.c"
    break;

  case 59: /* unit_part_block: IDENTIFIER  */
#line 460 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
                                 { (yyval.strValue) = (yyvsp[0].strValue); }
#line 1705 "mc_gen_s115/y.tab.c"
    break;

  case 60: /* unit_part_block: IDENTIFIER INTEGER  */
#line 461 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
                                 { char tmp[32];
	    sprintf (tmp,"%d",(yyvsp[0].iValue)); (yyval.strValue) = find_concat_str_strings((yyvsp[-1].strValue),tmp,""); }
#line 1712 "mc_gen_s115/y.tab.c"
    break;

  case 61: /* unit_part_block: IDENTIFIER '-' INTEGER  */
#line 463 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
                                 { char tmp[32];
	    sprintf (tmp,"%d",(yyvsp[0].iValue)); (yyval.strValue) = find_concat_str_strings((yyvsp[-2].strValue),"-",tmp); }
#line 1719 "mc_gen_s115/y.tab.c"
    break;

  case 62: /* unit_part_block: IDENTIFIER '^' INTEGER  */
#line 465 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
                                     { char tmp[32];
	    sprintf (tmp,"%d",(yyvsp[0].iValue)); (yyval.strValue) = find_concat_str_strings((yyvsp[-2].strValue),"^",tmp); }
#line 1726 "mc_gen_s115/y.tab.c"
    break;

  case 63: /* unit_part_block: IDENTIFIER '^' '-' INTEGER  */
#line 467 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
                                     { char tmp[32];
	    sprintf (tmp,"%d",(yyvsp[0].iValue)); (yyval.strValue) = find_concat_str_strings((yyvsp[-3].strValue),"^-",tmp); }
#line 1733 "mc_gen_s115/y.tab.c"
    break;


#line 1737 "mc_gen_s115/y.tab.c"
...
#line 471 "/u/profi/aali/sfsRoot/UCESB/mapcalib/mc_parser.y"
