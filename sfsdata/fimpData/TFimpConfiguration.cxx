...
{   
    ...
    if (detector_map_file.fail()) sfsLOG(fatal, "Could not open FIMP mapping file!");
    ...
    sfsLOG(info, "FIMP Configuration File: " + mapping_file);
    return;
}
...
void TFimpConfiguration::ReadCalibrationCoefficients()
{
    ...
    if (cal_map_file.fail()) sfsLOG(warn, "Could not open Fimp calibration coefficients"); return; 
