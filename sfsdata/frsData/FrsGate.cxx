...
// read gates here.
    ...
    sfsLOG(info, Form("PID gate %s loaded with cuts on Z/AoQ = %i, Z/Z2 = %i, x2/AoQ = %i, x4/AoQ = %i, dEdeg/Z = %i",
    gate_name.c_str(),
    cut_Z_AoQ!=nullptr,
    cut_Z_Z2!=nullptr,
    cut_x2_AoQ!=nullptr,
    ...
    {
        sfsLOG(info, Form("PID gate cut_Z_AoQ_driftcorr loaded with cuts on Z/AoQ = %i",
