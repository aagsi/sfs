...
//     if (MWD_parameters_file.fail()) sfsLOG(fatal, "Could not open LISA MWD parameters file.");
...
//     sfsLOG(info, "Lisa MWD Parameters: " + MWD_file);
//     return;
...
{   
    ...
    if (detector_map_file.fail()) sfsLOG(fatal, "Could not open Lisa mapping file"); //return;
    ...
    sfsLOG(info, "Lisa Configuration File: " + mapping_file);
    return;
...
{   
    ...
    if (gain_matching_coeff_file.fail()) sfsLOG(fatal, "Could not open LISA calibration coefficients file.");
    ...
    sfsLOG(info, "Lisa Gain Matching File: " + gain_matching_file);
    return;
...
void TLisaConfiguration::ReadCalibrationCoefficients()
{
    ...
    if (cal_map_file.fail()) sfsLOG(warn, "Could not open Lisa calibration coefficients"); return; 
