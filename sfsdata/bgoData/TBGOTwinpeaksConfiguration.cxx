...
void TBGOTwinpeaksConfiguration::ReadConfiguration()
{
    ...
    if (detector_map_file.fail()) sfsLOG(fatal, "Could not open BGO Twinpeaks allocation file");
...
void TBGOTwinpeaksConfiguration::ReadCalibrationCoefficients(){
    ...
    if (calibration_coeff_file.fail()) sfsLOG(fatal, "Could not open BGO calibration coefficients file.");
