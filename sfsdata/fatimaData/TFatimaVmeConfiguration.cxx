...
void TFatimaVmeConfiguration::ReadConfiguration()
{
    ...
    if (detector_map_file.fail()) sfsLOG(warn, "Could not open Fatima VME configuration map");
...
void TFatimaVmeConfiguration::Read_QDC_E_Calibration()
{
    ...
    if (calfile.fail()) sfsLOG(warn, "Could not open Fatima VME QDC E calibration file.");
...
void TFatimaVmeConfiguration::Read_QDC_T_Calibration()
{
    ...
    if (calfile.fail()) sfsLOG(warn, "Could not find Fatima VME QDC T Calibration file");
...
void TFatimaVmeConfiguration::Read_TDC_T_Calibration()
{
    ...
    if (calfile.fail()) sfsLOG(warn, "Could not find Fatima (VME) TDC Time Calibration file");
