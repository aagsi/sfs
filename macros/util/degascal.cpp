...
void man(){
    ...
    cout << "Functions:\n" << endl;
    cout << "1. yoink(\"filename\", \"outputfilename\", \"element\") - Reads calibration histograms from sfsRoot nearline histogram procedure and makes a .root file with the relevant histograms\n" << endl;
