...
{   
    ...
    TString filename = "/u/cjones/sfsRoot/macros/nearline_testing/run_0157_test.root";
    TString outputpath = "frs_histos";
    ...
    TFrsConfiguration::SetScalerMappingPath(config_path + "/frs/FRS_Scaler_Name_Mapping.txt");
    ...
    TExperimentConfiguration::SetExperimentStart(1715714444000000000);
    ...
    TFrsConfiguration::Set_Z_range(30,40);
