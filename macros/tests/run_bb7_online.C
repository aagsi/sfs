...
{   
    ...
    // TString sfsRoot_path = "/u/despec/s101_online/sfsRoot";
    TString sfsRoot_path = "/u/cjones/sfsRoot";
    // TString ucesb_path = sfsRoot_path + "/unpack/exps/" + fExpName + "/" + fExpName + " --input-buffer=200Mi --event-sizes";
    TString ucesb_path = sfsRoot_path + "/unpack/exps/" + "febex" + "/" + "febex" + " --debug --input-buffer=200Mi --event-sizes";
    ...
    // TBB7VmeConfiguration::SetDetectorConfigurationFile("/u/cjones/sfsRoot/config/s181/bb7/BB7_Detector_Map_s181.txt");
    //TBB7FebexConfiguration::SetMappingFile("/u/cjones/sfsRoot/config/s101/bb7/BB7_Detector_Map.txt");  
    TBB7FebexConfiguration::SetMappingFile("/u/despec/s101_online/sfsRoot/config/s101/bb7/BB7_Detector_Map_feb21.txt"); 
    ...
    // TBB7VmeConfiguration::SetResidualSignalsFile("/u/cjones/sfsRoot/config/s181/bb7/BB7_Residuals_Map.txt");   
