...
{   
    ...
    TString ucesb_path = sfsRoot_path + "/unpack/exps/" + fExpName + "/" + fExpName + " --debug --input-buffer=200Mi --event-sizes";
    ...
    std::string CorrConfigFile = std::string(sfsRoot_path.Data()) + "/config/" + std::string(fExpName.Data()) + "/correlations.dat";
    ...
    TFatimaVmeConfiguration::SetDetectorMapFile(std::string(sfsRoot_path.Data()) + "/config/s100/fatima/Fatima_VME_allocation.txt");
    TFatimaVmeConfiguration::Set_QDC_E_CalFile(std::string(sfsRoot_path.Data()) + "/config/s100/fatima/Fatima_QDC_Energy_Calibration.txt");
    TFatimaVmeConfiguration::Set_QDC_T_CalFile(std::string(sfsRoot_path.Data()) + "/config/s100/fatima/Fatima_QDC_Time_Calibration.txt");
    TFatimaVmeConfiguration::Set_TDC_T_CalFile(std::string(sfsRoot_path.Data()) + "/config/s100/fatima/Fatima_TDC_Time_Calibration.txt");
