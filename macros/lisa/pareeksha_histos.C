...
{   
    ...
    FrsGate* cut_0 = new FrsGate("cut", "/u/gandolfo/sfs/sfsRoot/config/pareeksha/frs/Gates/all_z_1.root"); 
    FrsGate* cut_1 = new FrsGate("0", "/u/gandolfo/sfs/sfsRoot/config/pareeksha/frs/Gates/1p1n.root"); 
    FrsGate* cut_2 = new FrsGate("1", "/u/gandolfo/sfs/sfsRoot/config/pareeksha/frs/Gates/1p2n.root"); 
    FrsGate* cut_3 = new FrsGate("2", "/u/gandolfo/sfs/sfsRoot/config/pareeksha/frs/Gates/all_z_2.root"); 
    FrsGate* cut_4 = new FrsGate("2", "/u/gandolfo/sfs/sfsRoot/config/pareeksha/frs/Gates/2p3n.root"); 
    FrsGate* cut_5 = new FrsGate("2", "/u/gandolfo/sfs/sfsRoot/config/pareeksha/frs/Gates/2p4n.root"); 
