...
{   
    ...
    TString outputpath = "/u/gandolfo/data/lustre/gamma/LISA/data/sfsdata/";
   ...
   //TString ucesb_dir = getenv("UCESB_DIR"); // .bashrc
    TString temp_path = "/u/gandolfo/sfs/sfsRoot/unpack/exps"; //at some point move to common computer
    //TString ucesb_dir = "/u/despec/s100_online/sfsRoot/unpack/exps";
    TString ucesb_path = temp_path + "/lisa/lisa --allow-errors --input-buffer=200Mi";
    ucesb_path.ReplaceAll("//","/");

    //set mapping
    //TLisaConfiguration::SetMappingFile("/u/gandolfo/sfs/sfsRoot/config/lisa/Lisa_Detector_Map.txt");
    TLisaConfiguration::SetMappingFile("/u/gandolfo/sfs/sfsRoot/config/lisa/Lisa_Detector_Map_names.txt");
