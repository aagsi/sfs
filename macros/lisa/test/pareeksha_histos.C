...
{   
    ...
    FrsGate* cut_0 = new FrsGate("0", "/u/gandolfo/sfs/sfsRoot/config/pareeksha/frs/Gates/cut_Z_AoQ_0.root");
    FrsGate* cut_1 = new FrsGate("1", "/u/gandolfo/sfs/sfsRoot/config/pareeksha/frs/Gates/cut_Z_AoQ_1.root");
    FrsGate* cut_2 = new FrsGate("2", "/u/gandolfo/sfs/sfsRoot/config/pareeksha/frs/Gates/cut_Z_AoQ_2.root");
    FrsGate* cut_3 = new FrsGate("3", "/u/gandolfo/sfs/sfsRoot/config/pareeksha/frs/Gates/cut_Z_AoQ_3.root");
