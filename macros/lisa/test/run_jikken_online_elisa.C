...
{   
    ...
    //___O F F L I N E
    TString filename = "/u/gandolfo/data/lustre/gamma/LISA/data/jikken/run23_0001.lmd"; 

    //___O U T P U T
    TString outputpath = "/u/gandolfo/data/lustre/gamma/LISA/data/sfsdata/";
    TString outputFilename = outputpath + "jikken_test.root";
