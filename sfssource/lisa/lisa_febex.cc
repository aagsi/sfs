...
void lisa_febex::initOptTree(){
	...
	optTree->Branch("TRIGGER_sfs",&TRIGGER_sfs,"TRIGGER_sfs/I");
	optTree->Branch("EVENTNO_sfs",&EVENTNO_sfs,"EVENTNO_sfs/I");
...
void lisa_febex::fillOptTree(febex_data &fopt){
	...
	TRIGGER_sfs = fopt.trigger;
	EVENTNO_sfs = fopt.evtno;
...
void lisa_febex::clearOptTree(){
	...
	TRIGGER_sfs = 0; //UInt_t
	EVENTNO_sfs = 0; //UInt_t
