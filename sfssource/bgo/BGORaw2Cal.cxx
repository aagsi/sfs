...
*/
BGORaw2Cal::~BGORaw2Cal(){
    sfsLOG(info, "Deleting BGORaw2Cal task");
...
{  
    ...
    sfsLOG(info, "Grabbing FairRootManager, RunOnline and EventHeader.");
    ...
    sfsLOG_IF(fatal, !funcal_data, "BGO branch of BGOTwinpeaksData not found.");
