...
void AidaCal2Hit::Exec(Option_t* option)
{
    ...
    if (implantCalArray->size() > 0)
    {
        ...
        for (auto& i: clusters)
        {
            // TODO: is this possible in sfsRoot?
...
AidaHit AidaCal2Hit::ClusterPairToHit(std::pair<AidaCluster, AidaCluster> const& i)
{
    ...
    //sfsLOG_IF(error, i.first.DSSD != i.second.DSSD, "Cluster pair of mismatched DSSDS");
    //sfsLOG_IF(error, i.first.Side == i.second.Side, "Cluster pair not of X and Y");
