...
Bool_t GermaniumReader::Read()
{
    ...
    for (int it_board_number = 0; it_board_number < NBoards; it_board_number ++)
    {
        ...
        if (fData->germanium_data[it_board_number].channel_energy != fData->germanium_data[it_board_number].channel_cfd) sfsLOG(warning,"Inconsistent size of arrays");

        for (int index = 0; index < fData->germanium_data[it_board_number].channel_energy; index++)
        {   
            
            //sfsLOG(info,Form("channel_energy = %i, channel_energyI[%i] = %d, channel_energyv[%i] = %d;",fData->germanium_data[it_board_number].channel_energy,index,fData->germanium_data[it_board_number].channel_energyI[index],index,fData->germanium_data[it_board_number].channel_energyv[index]));
            //sfsLOG(info,Form("channel_id = %i, channel_idI[%i] = %d, channel_idv[%i] = %d;",fData->germanium_data[it_board_number].channel_id,index,fData->germanium_data[it_board_number].channel_idI[index],index,fData->germanium_data[it_board_number].channel_idv[index]));
            if (fData->germanium_data[it_board_number].channel_trigger_time_hiI[index] != fData->germanium_data[it_board_number].channel_trigger_time_loI[index]) sfsLOG(fatal, "Wrong in array fillings. channel_trigger_time_loI != channel_trigger_time_hiI "); 
            if (fData->germanium_data[it_board_number].channel_trigger_time_hiI[index] != fData->germanium_data[it_board_number].pileupI[index]) sfsLOG(fatal, "Wrong in array fillings. pileupI != channel_trigger_time_hiI ");
            if (fData->germanium_data[it_board_number].channel_trigger_time_hiI[index] != fData->germanium_data[it_board_number].overflowI[index]) sfsLOG(fatal, "Wrong in array fillings. overflowI != channel_trigger_time_hiI ");
            if (fData->germanium_data[it_board_number].channel_trigger_time_hiI[index] != fData->germanium_data[it_board_number].channel_cfdI[index]) sfsLOG(fatal, "Wrong in array fillings. channel_cfdI != channel_trigger_time_hiI ");
            if (fData->germanium_data[it_board_number].channel_trigger_time_hiI[index] != fData->germanium_data[it_board_number].channel_energyI[index]) sfsLOG(fatal, "Wrong in array fillings. channel_energyI != channel_trigger_time_hiI ");
