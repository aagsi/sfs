...
GermaniumCal2Anl::~GermaniumCal2Anl(){
    sfsLOG(info, "Deleting GermaniumCal2Anl task");
...
InitStatus GermaniumCal2Anl::Init()
{
    ...
    sfsLOG_IF(fatal, !fcal_ge_data, "Germanium branch of GermaniumCalData not found.");

    fcal_bgo_data = (TClonesArray*)mgr->GetObject("BGOTwinpeaksCalData");
    sfsLOG_IF(fatal, !fcal_bgo_data, "BGO data not found.");
            ...
            if (AddBack_veto == true){
                ...
                if (event_multiplicity > 1){
                    for (Int_t ihit2 = ihit+1; ihit2 < event_multiplicity; ihit2++){
                        ...
                        //sfsLOG(info,Form("detector_id1 = %i, detector_id2 = %i, dt = %f, energy1 = %f, energy2 = %f",detector_id1, detector_id2, TMath::Abs(time2 - time1), energy1, energy2));
