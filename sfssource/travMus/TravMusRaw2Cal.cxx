...
TravMusRaw2Cal::~TravMusRaw2Cal()
{
    sfsLOG(info, "Deleting TravMusRaw2Cal task");
    delete adcArray;
    delete tdcArray;
    delete calArray;
}
...
InitStatus TravMusRaw2Cal::Init()
{
    ...
    sfsLOG_IF(fatal, !adcArray, "Branch TravMusAdcData not found!");
    tdcArray = mgr->InitObjectAs<decltype(tdcArray)>("TravMusTdcData");
    sfsLOG_IF(fatal, !tdcArray, "Branch TravMusTdcData not found!");
